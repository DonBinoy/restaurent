    ...
    <section className="bg-white py-16 relative overflow-hidden z-20">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[300px] h-[300px] bg-[var(--color-accent)]/20 blur-[100px] rounded-full pointer-events-none"></div>

          <div className="flex-1 text-center md:text-left relative z-10">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/10 text-[var(--color-accent)] mb-6 mx-auto md:mx-0">
              <Gift size={24} />
            </div>
            <h2 className="font-title font-black text-3xl md:text-5xl text-white uppercase tracking-tight leading-none mb-4">
              Corporate &<br/> Wedding Gifting
            </h2>
            <p className="text-white/70 font-sans font-light text-sm md:text-base max-w-md mx-auto md:mx-0 leading-relaxed">
              Make your celebrations sweeter. We offer custom branding, bulk discounts, and pan-India shipping for all your special events.
            </p>
          </div>
